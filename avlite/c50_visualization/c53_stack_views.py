...
class PlanFrame(ttk.LabelFrame):
    def __init__(self, root: VisualizerApp, view:ttk.Frame):
        ...
        global_show = ttk.Checkbutton(global_frame, text="Global", command=self.root.update_views, variable=self.root.setting.global_plan_view)
        ...
        local_show = ttk.Checkbutton(wp_frame, text="Local", command=self.root.update_views, variable=self.root.setting.local_plan_view)
        local_show.pack(side=tk.LEFT)
        attach_schema_tooltip(local_show, VisualizationSettings, "local_plan_view")
        local_g = ttk.Checkbutton(wp_frame, text="G", variable=self.root.setting.show_local_global_view, command=self.root.update_ui)
        local_g.pack(side=tk.LEFT)
        local_f = ttk.Checkbutton(wp_frame, text="F", variable=self.root.setting.show_local_frenet_view, command=self.root.update_ui)
        local_f.pack(side=tk.LEFT)
        attach_schema_tooltip(local_g, VisualizationSettings, "show_local_global_view")
        attach_schema_tooltip(local_f, VisualizationSettings, "show_local_frenet_view")
