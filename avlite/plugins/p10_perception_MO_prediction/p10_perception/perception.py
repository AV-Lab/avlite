...
from avlite.plugins.p10_perception_MO_prediction.settings import PluginSettings
...
class MultiObjectPredictor(PredictionStrategy):
    ...
    def __init__(self):
        ...
        self.detector = PluginSettings.detector
        self.tracker = PluginSettings.tracker
        self.predictor = PluginSettings.predictor
        self.device = PluginSettings.device
        self.output_mode = PluginSettings.prediction_mode
        self.max_agent_distance = PluginSettings.max_agent_distance
    ...
    def import_models(self, module: str) -> type:
        ...
        try:
            module_name = f"avlite.plugins.p10_perception_MO_prediction.p10_perception.{module}"
