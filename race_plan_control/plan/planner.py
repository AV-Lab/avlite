...
class Planner(ABC):
    ...
    def __init__(self, reference_path, ref_left_boundary_d, ref_right_boundary_d):
        ...
        self.ref_left_boundary_x, self.ref_left_boundary_y = self.global_trajectory.convert_sd_path_to_xy_path(self.global_trajectory.path_s, self.ref_left_boundary_d)
        self.ref_right_boundary_x, self.ref_right_boundary_y = self.global_trajectory.convert_sd_path_to_xy_path(self.global_trajectory.path_s, self.ref_right_boundary_d)
