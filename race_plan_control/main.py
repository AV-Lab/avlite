...
def load_config(config_path):
    ...
    if is_running_from_source:
        current_file_name = (
            os.path.realpath(__file__) if sys.argv[0] == "" else sys.argv[0]
        )
    else:
    ...
    with open(path_to_track, "r") as f:
        ...
        reference_path = [
            point[:2] for point in track_data["ReferenceLine"]
        ]  # ignoring z
...
def get_executer():
    ...
    SimpleSim = race_plan_control.execute.executer.Executer
